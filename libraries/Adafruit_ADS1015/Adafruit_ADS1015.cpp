...
void Adafruit_ADS1015::begin() {
  Wire.begin();
  writeRegister ( m_i2cAddress, (uint8_t)ADS1015_REG_POINTER_LOWTHRESH, (uint16_t)0x7fff ) ;
  writeRegister ( m_i2cAddress, (uint8_t)ADS1015_REG_POINTER_HITHRESH, (uint16_t)0x8000 ) ;
// DEFAULT
//  writeRegister ( m_i2cAddress, (uint8_t)ADS1015_REG_POINTER_LOWTHRESH, (uint16_t)0x8000 ) ;
//  writeRegister ( m_i2cAddress, (uint8_t)ADS1015_REG_POINTER_HITHRESH, (uint16_t)0x7fff ) ;
}
